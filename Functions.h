...
using namespace std;
template <class T>
class Functions1: public BinarySearchTree<T>, public BinaryTree<T>, public TreeChildrenList<T>
{
public:
	friend class Node<T>;
...
private:
	...
	Node<T>* FindPrivate2(T inf, Node<T>* node)
	{
	...
	Node<T>* FindPrivate3(T e, Node<T>* node) {
		if (node != NULL)
		{
			if (node->data == e)
			{
